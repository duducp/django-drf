...
from project.logging import processors
...
LOCALE_PATHS = [os.path.join(BASE_DIR, 'project', 'locales')]
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'project', 'statics')]
...
LOCAL_MIDDLEWARE = [
    'project.middlewares.version_header.VersionHeaderMiddleware',
]
...
# Ex.: DRF_YASG_EXCLUDE_VIEWS = ['project.apps.clients.views.ClientFavoriteDetailView'] # noqa
...
LOGGING = {
    ...
    'filters': {
        ...
        'ignore_if_contains': {
            '()': 'project.logging.filters.IgnoreIfContains',
