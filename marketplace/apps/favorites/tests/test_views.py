...
from marketplace.apps.favorites.tests.schemas import FavoriteSchema
...
class TestFavoriteCreateView:
    ...
    def mock_logger(self):
        with patch(
            'marketplace.apps.favorites.views.logger'
        ) as mock:
            yield mock
    ...
    def mock_get_product(self):
        with patch(
            'marketplace.apps.favorites.serializers.ProductBackend'
        ) as mock:
