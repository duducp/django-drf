...
MEDIA_ROOT = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(BASE_DIR))), 'medias')  # noqa
MEDIA_URL = '/medias/'
STATIC_ROOT = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(BASE_DIR))), 'staticfiles')  # noqa
STATIC_URL = '/statics/'

ADMIN_URL = 'admin/'
ADMIN_ENABLED = strtobool(os.getenv('ADMIN_ENABLED', 'true'))
ADMIN_SITE_HEADER = 'Django Administration'
ADMIN_SITE_TITLE = 'Django + DRF'
...
LOCAL_APPS = [
    ...
    'project.clients.apps.ClientsConfig',
    'project.favorites.apps.FavoritesConfig',
]
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'project.core.exceptions.custom_exception_handler',
...
# Ex.: DRF_YASG_EXCLUDE_VIEWS = ['project.clients.views.ClientFavoriteDetailView'] # noqa
